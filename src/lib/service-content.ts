...
export const SERVICE_DETAILS: Record<string, ServiceDetail> = {
  "water-lines": {
    ...
    metaDescription:
      "Need a water line run to your garage, pole barn, or outbuilding? We bore it underground — no trench, no torn-up yard, done in a day. Free quotes in Northern Michigan.",
  ...
  septic: {
    ...
    metaDescription:
      "Septic lines and pump-up systems installed underground by boring — no open trench across your property. Working with your septic installer in Northern Michigan.",
    headline: "Septic Lines — Installed Underneath, Not Dug Through",
    description:
  ...
  drainage: {
    ...
    metaDescription:
      "Underground drainage installed without trenching: buried downspouts, foundation drains, and yard drainage that moves water away — with your lawn left untouched.",
  ...
  power: {
    ...
    headline: "Run Power to Any Building — No Trench Required",
    description:
  ...
  gas: {
    ...
    metaDescription:
      "Gas and propane lines bored underground — to garages, pole barns, generators, and pool heaters — without an open trench through your yard. Northern Michigan, free quotes.",
    headline: "Gas & Propane Lines — Buried Without the Backhoe",
    description:
  ...
  irrigation: {
    ...
    headline: "Irrigation Lines — Long Runs, Zero Surface Damage",
    description:
  ...
  fiber: {
    ...
    headline: "Internet to Your Pole Barn — Cable Buried, Yard Intact",
    description:
